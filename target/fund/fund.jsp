            ...
            <div class="container-fluid p-0">
                            ...
                            <div class="card-body py-4">
                                <div class="d-flex align-items-start">
                                    <div class="flex-grow-1">
                                        <h3 class="mb-2">${requestScope.fund_info.fname}</h3>
                                        <p class="mb-2">${requestScope.fund_info.fid}</p>
                                        <div class="mb-0">
                    ...
                    <div class="col-auto ms-auto text-end mt-n1">
                        ...
                        <div class="dropdown me-2 d-inline-block">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                ...
                                <a class="dropdown-item" href="https://appstack.bootlab.io/dashboard-default.html#">Action</a>
                                <a class="dropdown-item" href="https://appstack.bootlab.io/dashboard-default.html#">Another
                                    action</a>
                                <a class="dropdown-item" href="https://appstack.bootlab.io/dashboard-default.html#">Something
                                    else here</a>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="https://appstack.bootlab.io/dashboard-default.html#">Separated
                                    link</a>
                            </div>
                        </div>

                        <button class="btn btn-primary shadow-sm">
                            <svg width="100%" height="100%" viewBox="0 0 8 8" version="1.1" fill="currentColor"
                                 xmlns="http://www.w3.org/2000/svg"
                                 xml:space="preserve"
                                 style="fill-rule:evenodd;clip-rule:evenodd;stroke-linejoin:round;stroke-miterlimit:2;"
                                 class="feather feather-refresh-cw align-middle">
                                <g transform="matrix(1,0,0,1,-4,-4)">
                                    <path d="M8,4C8.274,4 8.5,4.226 8.5,4.5L8.5,7.5L11.5,7.5C11.774,7.5 12,7.726 12,8C12,8.274 11.774,8.5 11.5,8.5L8.5,8.5L8.5,11.5C8.5,11.774 8.274,12 8,12C7.726,12 7.5,11.774 7.5,11.5L7.5,8.5L4.5,8.5C4.226,8.5 4,8.274 4,8C4,7.726 4.226,7.5 4.5,7.5L7.5,7.5L7.5,4.5C7.5,4.226 7.726,4 8,4Z"
                    ...
                    <div class="col-12 col-lg-8 d-flex">
                        <div class="card flex-fill w-100">
                            <div class="card-header">
                                ...
                                <h5 class="card-title mb-0">持有</h5>
                            </div>
                            <div id="datatables-dashboard-projects_wrapper2"
                                 class="dataTables_wrapper dt-bootstrap5 no-footer">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <table id="datatables-dashboard-projects2"
                                            ...
                                            <tr>
                                                ...
                                                <th class="d-none d-xl-table-cell sorting" tabindex="0"
                                                    aria-controls="datatables-dashboard-projects" rowspan="1"
                                                    colspan="1"
                                                    aria-label="Start Date: activate to sort column ascending">买入时间
                                                </th>
                                                <th class="d-none d-xl-table-cell sorting" tabindex="0"
                                                    aria-controls="datatables-dashboard-projects" rowspan="1"
                                                    colspan="1"
                                                    aria-label="End Date: activate to sort column ascending">买入净值
                                                </th>
                                                <th class="sorting" tabindex="0"
                                                    aria-controls="datatables-dashboard-projects"
                                                    rowspan="1" colspan="1"
                                                    aria-label="Status: activate to sort column ascending">份额
                                                </th>
                                            </tr>
                                            </thead>
                                            <tbody id="hold">
                    ...
                    <div class="col-12 col-lg-4 d-flex">
                        <div class="card flex-fill w-100">
                            <div class="card-header">
                                ...
                                <h5 class="card-title mb-0">买入</h5>
                            </div>
                            <div class="card-body">
                                <form method="post" id="form1">
                                    <label>买入时间</label>
                                    <input type="text" class="form-control"
                                           value=${requestScope.simpleDateFormat.format(requestScope.now)} id="hdate"
                                           name="hdate">
                                    <br>
                                            ...
                                            $(function () {
                                                $("#buy").click(function () {
                                                    $.ajax({
                                                        ...
                                                        url: "./add_buy",
                                                        data: {
                                                            fid: "${requestScope.fund_info.fid}",
                                                            date: $("#hdate").val(),
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-lg-6 col-xl-4 <%--d-flex--%>">
                        <div class="card flex-fill">
                            <div class="card-header">
                                ...
                                <h5 class="card-title mb-0">收益率确认</h5>
                            </div>
                            <div class="card-body">
                                <div class="mb-3">
                                    <label class="form-label">目标收益率</label>
                                    <div class="row">
                                        <div class="col-12 col-lg-6"><input class="form-control" value="8.00"
                                                                            id="target"></div>
                                        %
                                    </div>
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">昨日净值</label>
                                    <div class="row">
                                        <div class="col-12 col-lg-9">
                                            <input class="form-control" placeholder="请输入昨日基金的净值"
                                                   id="pre-price"></div>
                                    </div>

                                </div>
                                <div class="mb-3">
                                    <label class="form-label">估值</label>
                                    <div class="row">
                                        <div class="col-12 col-lg-9">
                                            <input type="email" class="form-control"
                                                   placeholder="请输入今日的估值" id="valuation"></div>
                                        %
                                    </div>
                                ...
                                <div class="mb-3 text-md-center">
                                    <label class="form-check m-0">
                                        <button type="button" class="btn btn-primary" aria-haspopup="true"
                                                id="submitFund" onclick="satisfied()">
                                            查找
                                        </button>
                                    </label>
                                </div>
                        ...
                        <div class="card flex-fill">
                            <div class="card-header">
                                ...
                                <h5 class="card-title mb-0">卖出</h5>
                            </div>
                            <div class="card-body">
                                <label for="sd">卖出时间</label>
                                &nbsp;&nbsp;
                                <input type="text" class="form-control" style="width: auto; display: inline;"
                                       value="${requestScope.simpleDateFormat.format(requestScope.now)}" id="sd"
                                       name="sd">
                                <br><br>
                                                    ...
                                                    if ($(this).children("td").children("input").is(":checked") === true) {
                                                        $.ajax({
                                                            ...
                                                            data: {
                                                                sid: $(this).attr("sid"),
                                                                sold_date: $("#sd").val(),
                                                                sold_price: $("#sale_price").val()
                                                            },
                                                            success: function (data) {
                                                                cnt_success += 1;
                                                                if (cnt_success === cnt && cnt !== 0) {
                                                                    window.location.reload();
                                                                }
                                                            }
                                                        })
                    ...
                    <div class="col-12 col-lg-6 col-xl-8 d-flex">
                        <div class="card flex-fill w-100">
                            ...
                            <div id="datatables-dashboard-projects_wrapper3"
                                 class="dataTables_wrapper dt-bootstrap5 no-footer">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <table id="datatables-multi"
                                               class="table table-striped my-0 dataTable no-footer tab1"
                                            ...
                                            <tr>
                                                ...
                                                <th class="sorting" tabindex="0" aria-controls="datatables-multi"
                                                    ...
                                                    aria-label="Position: activate to sort column ascending">买入时间
                                                </th>
                                                <th class="sorting" tabindex="0" aria-controls="datatables-multi"
                                                    rowspan="1" colspan="1" style="width: 200px;"
                                                    aria-label="Office: activate to sort column ascending">买入净值
                                                </th>
                                                <th class="sorting" tabindex="0" aria-controls="datatables-multi"
                                                    rowspan="1" colspan="1" style="width: 200px;"
                                                    aria-label="Age: activate to sort column ascending">份额
                                                </th>
                                            </tr>
                                            </thead>
                                            <tbody id="bodyBox">
                                            <c:forEach items="${requestScope.funds_hold}" var="fund" varStatus="s">
                                                <tr class="tr2" sid="${fund.sid}">
                                                    <td id="ck"><input type="checkbox" class="form-check-input" id="ok">
                                                    </td>
                                                    <td>${fund.ddate}</td>
                ...
                <div class="card flex-fill">
                    <div class="card-header">
                        <div class="card-actions float-end">
                            <div class="dropdown position-relative">
                                <a href="https://appstack.bootlab.io/dashboard-default.html#" data-bs-toggle="dropdown"
                                   data-bs-display="static">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                         fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                        ...
                        <h5 class="card-title mb-0">收入</h5>
                    </div>
                            ...
                            <div class="col-sm-12">
                                <table id="datatables-dashboard-projects"
                                    ...
                                    <tr>
                                        ...
                                        <th class="d-none d-xl-table-cell sorting" tabindex="0"
                                            aria-controls="datatables-dashboard-projects" rowspan="1" colspan="1"
                                            aria-label="End Date: activate to sort column ascending">卖出时间
                                        </th>
                                        <th class="sorting" tabindex="0" aria-controls="datatables-dashboard-projects"
                                            rowspan="1" colspan="1"
                                            aria-label="Status: activate to sort column ascending">买入净值
                                        </th>
                                        <th class="d-none d-md-table-cell sorting" tabindex="0"
                                            aria-controls="datatables-dashboard-projects" rowspan="1" colspan="1"
                                            aria-label="Assignee: activate to sort column ascending">卖出净值
                                        </th>
                                        <th class="d-none d-md-table-cell sorting" tabindex="0"
                                            aria-controls="datatables-dashboard-projects" rowspan="1" colspan="1"
                                            aria-label="Assignee: activate to sort column ascending">份额
                                        </th>
                                        <th class="d-none d-md-table-cell sorting" tabindex="0"
                                            aria-controls="datatables-dashboard-projects" rowspan="1" colspan="1"
                                            aria-label="Assignee: activate to sort column ascending">收益
                                        </th>
                                    </tr>
                                    </thead>
                                    <tbody>
                ...
                <div class="row">
                    <div class="col-12 col-lg-8 d-flex">
                        <div class="card flex-fill w-100">
                            <div class="card-header">
                                ...
                                <h5 class="card-title mb-0">业绩走势</h5>
                            </div>
                            <div id="datatables-dashboard-projects_wrapper4"
                                 class="dataTables_wrapper dt-bootstrap5 no-footer">
                                <div class="row">
                                    <div class="col-sm-12">
                                    </div>
                    ...
                    <div class="col-12 col-lg-4 d-flex">
                        <div class="card flex-fill w-100">
                            <div class="card-header">
                                <span class="badge bg-info float-end">Today</span>
                                <h5 class="card-title mb-0">估值</h5>
                            </div>
                            <div class="card-body">
                            </div>
                        </div>
