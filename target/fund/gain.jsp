            ...
            <div class="container-fluid p-0">
                ...
                <div class="card flex-fill">
                    <div class="card-header">
                        ...
                        <h5 class="card-title mb-0">收益统计</h5>
                    </div>
                    <div id="datatables-dashboard-projects_wrapper" class="dataTables_wrapper dt-bootstrap5 no-footer">
                        <div class="row">
                            <div class="col-sm-12">
                                <table class="table table-striped my-0 dataTable no-footer">
                                    <thead>
                                    <tr>
                                        <th class="d-none d-xl-table-cell sorting" tabindex="0" aria-controls="datatables-multi"
                                            rowspan="1" colspan="1" style="width: 200px;"
                                            aria-label="Age: activate to sort column ascending">基金名称</th>
                                        <th class="d-none d-xl-table-cell sorting" tabindex="0" aria-controls="datatables-multi"
                                            rowspan="1" colspan="1" style="width: 100px;"
                                            aria-label="Age: activate to sort column ascending">买入时间</th>
                                        <th class="d-none d-xl-table-cell sorting" tabindex="0" aria-controls="datatables-multi"
                                            rowspan="1" colspan="1" style="width: 100px;"
                                            aria-label="Age: activate to sort column ascending">卖出时间</th>
                                        <th class="d-none d-xl-table-cell sorting" tabindex="0" aria-controls="datatables-multi"
                                            rowspan="1" colspan="1" style="width: 70px;"
                                            aria-label="Age: activate to sort column ascending">买入净值</th>
                                        <th class="d-none d-xl-table-cell sorting" tabindex="0" aria-controls="datatables-multi"
                                            rowspan="1" colspan="1" style="width: 70px;"
                                            aria-label="Age: activate to sort column ascending">卖出净值</th>
                                        <th class="d-none d-xl-table-cell sorting" tabindex="0" aria-controls="datatables-multi"
                                            rowspan="1" colspan="1" style="width: 70px;"
                                            aria-label="Age: activate to sort column ascending">份额</th>
                                        <th class="d-none d-xl-table-cell sorting" tabindex="0" aria-controls="datatables-multi"
                                            rowspan="1" colspan="1" style="width: 70px;"
                                            aria-label="Age: activate to sort column ascending">收益</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <c:forEach items="${requestScope.tot_gain}" var="fund" varStatus="s">
                                        <tr>
                                            <td>
                                                <c:if test="${fund.fund_id == 1}">
                                                    景顺长城新能源产业股票C
                                                </c:if>
                                                <c:if test="${fund.fund_id == 2}">
                                                    景顺长城电子信息产业股票A
                                                </c:if>
                                                <c:if test="${fund.fund_id == 3}">
                                                    景顺长城新兴成长混合
                                                </c:if>
                                                <c:if test="${fund.fund_id == 4}">
                                                    中欧医疗健康混合C
                                                </c:if>
                                                <c:if test="${fund.fund_id == 5}">
                                                    广发高端制造股票A
                                                </c:if>
                                                    <%--                                ${fund.fund_id}--%>
                                                    <%--                                <%--%>
