window.hjSiteSettings = window.hjSiteSettings || {
    ...
    "heatmaps": [],
    "polls": [],
    "integrations": {"optimizely": {"tag_recordings": false}, "google_optimize": {"tag_recordings": false}},
    ...
    252: function (e, t) {
        window.hjBootstrap = window.hjBootstrap || function (e, t, n) {
            var o = ["bot", "google", "headless", "baidu", "bing", "msn", "duckduckbot", "teoma", "slurp", "yandex", "phantomjs", "pingdom", "ahrefsbot"].join("|"),
                a = new RegExp(o, "i"), i = window.navigator || {userAgent: "unknown"},
                r = i.userAgent ? i.userAgent : "unknown";
            if (a.test(r)) console.warn("Hotjar not launching due to suspicious userAgent:", r); else {
                var s = "http:" === window.location.protocol, d = Boolean(window._hjSettings.preview);
                if (!s || d) {
        ...
        }, window.hjBootstrap("https://script.hotjar.com/", "modules.bcd9ade6b0bb9bdd0789.js", "2120269"), window.hjLazyModules = window.hjLazyModules || {
            SURVEY_V2: {js: "survey-v2.afbc977db7eaef4b1791.js"},
            SURVEY_BOOTSTRAPPER: {js: "survey-bootstrapper.60aa22dfdb3f3ea2957c.js"},
            SURVEY_ISOLATED: {js: "survey-isolated.61dcf09b5fcba8be7fc6.js"},
            HEATMAP_SCREENSHOTTER: {js: "heatmap-screenshotter.c17f15d7f8b6d6be719a.js"},
            HEATMAP_VIEWER: {js: "heatmap-viewer.b14852a587841276b92d.js"},
            HEATMAP_DYNAMIC_VIEW: {js: "heatmap-dynamic-view.090f7af857c058ab40b4.js"},
            HEATMAP_RETAKER: {js: "heatmap-retaker.ac32823b4081fb7e74f6.js"},
            SURVEY_INVITATION: {js: "survey-invitation.6ed357e33ec8fcd1cdde.js"},
            NOTIFICATION: {js: "notification.46d33b754089f2174f2c.js"},
            INCOMING_FEEDBACK: {js: "incoming-feedback.52a6ff2ce48354d75a4f.js"},
            PREACT_INCOMING_FEEDBACK: {js: "preact-incoming-feedback.a43b176a785c6c989195.js"},
